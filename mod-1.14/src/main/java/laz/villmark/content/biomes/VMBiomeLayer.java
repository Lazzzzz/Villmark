...
public class VMBiomeLayer implements IC0Transformer 
{
	public static ImmutableList<BiomeManager.BiomeEntry> getBiomesToGeneration()
	{
        ...
        list.add(new BiomeManager.BiomeEntry(Biomes.BADLANDS, 100));
	...
	private final VMGenSettings settings;
	
	public VMBiomeLayer(WorldType p_i48641_1_, VMGenSettings p_i48641_2_) 
	{
