...
public class VMBiomeProvider extends BiomeProvider {
	   ...
	   private final Biome[] biomes = new Biome[]{Biomes.PLAINS, Biomes.DARK_FOREST};
	  
	   public VMBiomeProvider(VMBiomeProviderSettings settingsProvider) {
	      WorldInfo worldinfo = settingsProvider.getWorldInfo();
	      VMGenSettings vmgensettings = settingsProvider.getGeneratorSettings();
	      Layer[] alayer = VMLayerUtil.buildOverworldProcedure(worldinfo.getSeed(), worldinfo.getGenerator(), vmgensettings);
